window.addEventListener("DOMContentLoaded", function (event) {
    ...
    const speed = 220; // Milliseconds it takes for the snake to take a step in the grid
    ...
    function resetGame() {
      ...
      stepsTaken = -1; // -1 because then the snake will start with a step
      score = 0;
      contrast = 1;
    ...
    function main(timestamp) {
      try {
        ...
        // Write a note about restarting game 
        const pressSpaceToStart = "Press space to reset the game.";
        const followMe =
          'Follow me <a href="https://www.linkedin.com/in/can-akt%C3%BCrk-28bb77188/" , target="_blank">@Can Akturk</a>';
        noteElement.innerHTML = `${error.message}. ${pressSpaceToStart}  ${followMe}`;
        noteElement.style.opacity = 1;
